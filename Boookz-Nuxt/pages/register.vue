        ...
        <div class="">
            <form @submit.prevent="register" class="flex flex-col justify-between gap-3">
                ...
                <div class="">
                    ...
                    <input required class="input" size="28" type="name" name="firstname" id="firstname" placeholder="first name"
                        v-model="form.firstname">
                </div>

                <div class="">
                    <label for="lastname"></label>
                    <input required class="input" size="28" type="name" name="lastname" id="lastname" placeholder="last name"
                        v-model="form.lastname">
                </div>
                
                <div class="">
                    <label for="email"></label>
                    <input required class="input" size="28" type="email" name="email" id="email" placeholder="email address"
                        v-model="form.email">
